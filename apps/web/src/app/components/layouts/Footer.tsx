...
export default function Footer() {
  return (
    <footer className="bottom-0 left-0 fixed flex justify-between items-end p-2 pl-9 w-screen text-white">
      ...
      <div className="bg-clip-text pr-12 pb-0 w-[35%] overflow-hidden font-outfit font-thin text-lg text-end text-pretty tracking-wider">Let'em - Freak'in - Fight</div>
    </footer>
  );
}